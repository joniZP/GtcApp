...
QT_MOC_LITERAL(7, 86, 13), // "odbaciprijavu"
QT_MOC_LITERAL(8, 100, 5), // "index"
QT_MOC_LITERAL(9, 106, 1), // "j"
QT_MOC_LITERAL(10, 108, 17), // "verifikujLokaciju"
QT_MOC_LITERAL(11, 126, 2) // "id"

    },
    "LokacijaModel\0izbrisiprijavulokacije\0"
    "\0a\0izbrisilokaciju\0obrisiprijavu\0"
    "prihvatiprijavu\0odbaciprijavu\0index\0"
    "j\0verifikujLokaciju\0id"
};
...
void LokacijaModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->odbaciprijavu((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 5: _t->verifikujLokaciju((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
