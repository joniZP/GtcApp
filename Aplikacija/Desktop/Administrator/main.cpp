...
int main(int argc, char *argv[])
{
 ...
 //   SModel.dodajSliku(slika(10,"./ikonice/GTCLogo.png","Kej","Nis"));
  ...
  ucitavanjeprofila *ucita=new ucitavanjeprofila();
    engine.rootContext()->setContextProperty("ucitajprofilInstance", ucita);
   ...
   engine.rootContext()->setContextProperty("_KModel", &KModel);
    ...
    engine.rootContext()->setContextProperty("_PModel", &PModel);
   engine.load(url);
