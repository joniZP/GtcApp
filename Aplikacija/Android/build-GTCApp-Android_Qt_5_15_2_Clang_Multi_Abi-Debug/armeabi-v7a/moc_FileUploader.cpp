...
QT_MOC_LITERAL(1, 13, 11), // "uploadImage"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "imagename"
QT_MOC_LITERAL(4, 36, 4) // "path"

    },
    "FileUploader\0uploadImage\0\0imagename\0"
    "path"
};
...
void FileUploader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FileUploader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->uploadImage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])));
...
QT_INIT_METAOBJECT const QMetaObject FileUploader::staticMetaObject = { {
    ...
    qt_meta_stringdata_FileUploader.data,
    qt_meta_data_FileUploader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
