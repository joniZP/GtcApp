...
#include <memory>
#include "../../GTCApp/ucitavanjelokacije.h"
...
QT_MOC_LITERAL(1, 19, 11), // "getLokacija"
QT_MOC_LITERAL(2, 31, 10), // "MLokacija*"
QT_MOC_LITERAL(3, 42, 0), // ""
QT_MOC_LITERAL(4, 43, 2) // "id"

    },
    "UcitavanjeLokacije\0getLokacija\0"
    "MLokacija*\0\0id"
};
...
void UcitavanjeLokacije::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { MLokacija* _r = _t->getLokacija((*reinterpret_cast< int(*)>(_a[1])));
