...
void PretragaLokacija::reset()
{
    m.reset();
    mesto.reset();
}

void PretragaLokacija::pretrazi(QString text, int tip)
{
...
void PretragaLokacija::pretraziLokacije(QString text)
{
...
void PretragaLokacija::pretraziDogadjaje(QString text)
{
...
void PretragaLokacija::getGradoviKategorije()
{
    kategorije.clear();
    gradovi.clear();
...
void PretragaLokacija::ucitavanjeLokacijaPocetna()
{
    MySqlService &s = MySqlService::MySqlInstance();
    MySqlTable t;
    MyQuery query;
